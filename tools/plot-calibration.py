...
A = np.array(   [[1.056220, -0.015019, -0.034625],
            [-0.015019, 1.124144, 0.011954],
            [-0.034625, 0.011954, 1.200590]])
#A = np.identity(3)
b = np.array([-13.223829, -27.584509, 27.641636])
# b = np.array([0,0,0])


# Read raw data and apply calibration
rawData = np.genfromtxt('out.txt', delimiter='\t')[::10]  # Read raw measurements
